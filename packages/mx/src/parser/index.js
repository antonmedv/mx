...
*/
var index = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,5],$V1=[5,9,11],$V2=[1,12],$V3=[1,14],$V4=[11,12];
var parser = {trace: function trace() { },
yy: {},
symbols_: {"error":2,"Document":3,"StatementList":4,"EOF":5,"Statement":6,"StatementBlock":7,"INDENT":8,"DEDENT":9,"Tag":10,"IDENTIFIER":11,"NEWLINE":12,"AttributeList":13,"Attribute":14,"PlainAttribute":15,"=":16,"QUOTE":17,"AttributeValue":18,"TEXT":19,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",8:"INDENT",9:"DEDENT",11:"IDENTIFIER",12:"NEWLINE",16:"=",17:"QUOTE",19:"TEXT"},
productions_: [0,[3,2],[4,1],[4,2],[7,3],[6,1],[10,2],[10,3],[10,3],[10,4],[13,1],[13,2],[14,1],[15,5],[18,0],[18,1]],
...
table: [{3:1,4:2,6:3,10:4,11:$V0},{1:[3]},{5:[1,6],6:7,10:4,11:$V0},o($V1,[2,2]),o($V1,[2,5]),{11:$V2,12:[1,8],13:9,14:10,15:11},{1:[2,1]},o($V1,[2,3]),o($V1,[2,6],{7:13,8:$V3}),{11:$V2,12:[1,15],14:16,15:11},o($V4,[2,10]),o($V4,[2,12]),{16:[1,17]},o($V1,[2,8]),{4:18,6:3,10:4,11:$V0},o($V1,[2,7],{7:19,8:$V3}),o($V4,[2,11]),{17:[1,20]},{6:7,9:[1,21],10:4,11:$V0},o($V1,[2,9]),{17:[2,14],18:22,19:[1,23]},o($V1,[2,4]),{17:[1,24]},{17:[2,15]},o($V4,[2,13])],
defaultActions: {6:[2,1],23:[2,15]},
...
case 8:return "TEXT";
break;
case 9:this.popState(); return "QUOTE";
break;
}
},
...
conditions: {"INITIAL":{"rules":[0,1,2],"inclusive":true},"TAG":{"rules":[0,3,4,5,6,7],"inclusive":true},"ATTR":{"rules":[0,8,9],"inclusive":true}}
});
const indents = [0];
